...
//                  that.readThread(threadid);
   ...
   this.composeNew = function () {
      if (openInTab) {
         ...
         var composeWindow = window.open(mailURL + "?view=cm&fs=1&tf=1", 'Compose new message', 'width=800,height=600');
      }
   }
   ...
   this.sendPage = function (tab) {
      ...
      if (openInTab) {
         ...
         var composeWindow = window.open(urlToOpen, 'Compose new message', 'width=800,height=600');
      }
   }
   ...
   this.replyTo = function (mail) {
      ...
      if (openInTab) {
         ...
         var composeWindow = window.open(replyURL, 'Compose new message', 'width=800,height=600');
